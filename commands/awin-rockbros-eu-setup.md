...
All browser tool calls in this command MUST use `mcp__playwright-awin-rockbros-eu__*` exclusively.
Profile: `~/.claude/browser-profiles/awin-rockbros-eu` — port 9302.
NEVER use `mcp__playwright__`, `mcp__playwright-impact__`, `mcp__playwright-wellfound__`, or any other namespace — concurrent workflows will collide.
...
- workflow: `awin-rockbros-eu`
- target_total: (from $ARGUMENTS or default 2000)
- ledger_path: `/Volumes/workssd/ObsidianVault/01-Projects/Awin-Rockbros-EU-Outreach-Ledger.md`
- checkpoint_path: `/tmp/outreach-awin-rockbros-eu-checkpoint.json`
- mcp_namespace: `mcp__playwright-awin-rockbros-eu__`
