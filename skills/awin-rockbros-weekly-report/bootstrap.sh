#!/usr/bin/env bash
# bootstrap.sh — One-shot setup for awin-rockbros-weekly-report on a fresh Mac.
#
# Run this on a NEW Mac to get the entire workflow working. Steps:
#   1. Verify prereqs (Python 3.9+, gh, vercel, node)
#   2. Clone skill into ~/.claude/skills/awin-rockbros-weekly-report
...
REPO_URL="https://github.com/CitizenZM/awin-rockbros-weekly-report-skill.git"
SKILL_DIR="$HOME/.claude/skills/awin-rockbros-weekly-report"

echo "════════════════════════════════════════════════════════════════"
echo "  awin-rockbros-weekly-report — bootstrap"
echo "════════════════════════════════════════════════════════════════"
...
echo "    @awin-rockbros-weekly-report  (mention)"
echo "    or just say:  '生成 Rockbros 周报并发布'"
echo ""
