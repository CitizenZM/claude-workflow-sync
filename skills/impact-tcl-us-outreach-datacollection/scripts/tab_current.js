...
//
// Placeholders: Hi! We're reaching out on behalf of TCL — a global leader in TVs, smartphones & consumer electronics (200M+ products sold worldwide). We're exclusively offering our TOP partners a 10% CPAi commission — one of the highest rates in consumer electronics. Join leading publishers already earning with TCL. Please review the proposal and reach out with any questions. Excited to build a high-value partnership! 2026-05-14 ["forbes digital marketing inc.", "double clicks aps", "nerdwallet, inc.", "the motley fool", "nerdwallet compare inc", "people inc. - content", "nerdwallet, inc", "forbes media", "fusion media limited", "healthline media inc.", "bandsintown", "ad practitioners main", "todayshownbc", "buzzery llc.", "creditcards.com", "investopedia", "news corp au"] 2 https://app.impact.com/secure/advertiser/discover/radius/fr/partner_discover.ihtml?page=marketplace&slideout_id_type=partner#businessModels=CONTENT_REVIEWS&partnerStatuses=1&relationshipInclusions=prospecting&sortBy=reachRating&sortOrder=DESC
...
async (page) => {
  ...
  const MSG = "Hi! We're reaching out on behalf of TCL — a global leader in TVs, smartphones & consumer electronics (200M+ products sold worldwide). We're exclusively offering our TOP partners a 10% CPAi commission — one of the highest rates in consumer electronics. Join leading publishers already earning with TCL. Please review the proposal and reach out with any questions. Excited to build a high-value partnership!";
  const CONTRACT_DATE = "2026-05-14";
  const ALREADY = ["forbes digital marketing inc.", "double clicks aps", "nerdwallet, inc.", "the motley fool", "nerdwallet compare inc", "people inc. - content", "nerdwallet, inc", "forbes media", "fusion media limited", "healthline media inc.", "bandsintown", "ad practitioners main", "todayshownbc", "buzzery llc.", "creditcards.com", "investopedia", "news corp au"];
  const TARGET = 2;
